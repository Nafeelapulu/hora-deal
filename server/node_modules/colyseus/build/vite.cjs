...
var fetchModuleRunners = /* @__PURE__ */ new WeakMap();
function getModuleRunner(env) {
  if (env.runner) {
...
async function createFetchModuleRunner(env) {
  ...
  return new ModuleRunner({
    ...
    // V8 source maps, not a global Error.prepareStackTrace
    hmr: false
    // the plugin re-imports the entry itself on every change
