    ...
    "monitor-api-rooms": (0, import_core.createEndpoint)(`${prefix}/api`, { method: "GET", use }, async () => {
      ...
      try {
        ...
        return {
          ...
          memory: { totalMemMb, usedMemMb, rssMb: process.memoryUsage.rss() / 1024 / 1024, processId: import_core.matchMaker.processId }
        };
      } catch (e) {
